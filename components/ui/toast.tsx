...
function ToastComponent({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
  const getToastStyles = () => {
    const baseStyles = "min-w-80 p-4 rounded-lg border shadow-lg bg-[color:var(--color-card)] border-[color:var(--color-border)] animate-in slide-in-from-right duration-300"
