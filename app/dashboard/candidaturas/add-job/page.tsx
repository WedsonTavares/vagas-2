...
const AddJobPageOptimized = () => {
  ...
  const statusOptions = useMemo(
    () => [
      ...
      {
        value: JobStatus.TEST_PENDING,
        label: getStatusLabel(JobStatus.TEST_PENDING),
      },
      {
        value: JobStatus.TEST_COMPLETED,
        label: getStatusLabel(JobStatus.TEST_COMPLETED),
      },
      {
        value: JobStatus.INTERVIEW,
        label: getStatusLabel(JobStatus.INTERVIEW),
      },
        ...
        <div className='bg-[color:var(--color-card)] p-4 rounded-lg border border-[color:var(--color-border)]'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
            ...
            <div>
              <label
                htmlFor='title'
                className='block text-sm font-medium mb-1 text-[color:var(--color-primary)]'
              >
                Título da Vaga *
              </label>
              <input
